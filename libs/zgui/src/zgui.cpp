...
ZGUI_API void zguiSetAllocatorFunctions(
    void *(*alloc_func)(size_t, void *), void (*free_func)(void *, void *)
)
{
    ImGui::SetAllocatorFunctions(alloc_func, free_func, nullptr);
}

ZGUI_API void zguiSetNextWindowPos(
    float x, float y, ImGuiCond cond, float pivot_x, float pivot_y
)
{
...
ZGUI_API void zguiSetNextWindowFocus(void) { ImGui::SetNextWindowFocus(); }
...
ZGUI_API void zguiEndChild(void) { ImGui::EndChild(); }

ZGUI_API float zguiGetScrollX(void) { return ImGui::GetScrollX(); }

ZGUI_API float zguiGetScrollY(void) { return ImGui::GetScrollY(); }

ZGUI_API void zguiSetScrollX(float scroll_x) { ImGui::SetScrollX(scroll_x); }

ZGUI_API void zguiSetScrollY(float scroll_y) { ImGui::SetScrollY(scroll_y); }

ZGUI_API float zguiGetScrollMaxX(void) { return ImGui::GetScrollMaxX(); }

ZGUI_API float zguiGetScrollMaxY(void) { return ImGui::GetScrollMaxY(); }
...
ZGUI_API bool zguiIsWindowAppearing(void) { return ImGui::IsWindowAppearing(); }

ZGUI_API bool zguiIsWindowCollapsed(void) { return ImGui::IsWindowCollapsed(); }
...
ZGUI_API float zguiGetWindowWidth(void) { return ImGui::GetWindowWidth(); }

ZGUI_API float zguiGetWindowHeight(void) { return ImGui::GetWindowHeight(); }

ZGUI_API void zguiGetMouseDragDelta(
    ImGuiMouseButton button, float lock_threshold, float delta[2]
)
{
...
ZGUI_API void zguiIndent(float indent_w) { ImGui::Indent(indent_w); }

ZGUI_API void zguiUnindent(float indent_w) { ImGui::Unindent(indent_w); }
...
ZGUI_API void zguiBeginGroup(void) { ImGui::BeginGroup(); }

ZGUI_API void zguiEndGroup(void) { ImGui::EndGroup(); }
...
ZGUI_API float zguiGetCursorPosX(void) { return ImGui::GetCursorPosX(); }

ZGUI_API float zguiGetCursorPosY(void) { return ImGui::GetCursorPosY(); }
...
ZGUI_API int zguiGetMouseCursor(void) { return ImGui::GetMouseCursor(); }

ZGUI_API void zguiSetMouseCursor(int cursor) { ImGui::SetMouseCursor(cursor); }
...
ZGUI_API float zguiGetFrameHeight(void) { return ImGui::GetFrameHeight(); }
...
ZGUI_API void zguiEndDragDropSource() { return ImGui::EndDragDropSource(); }

ZGUI_API bool zguiBeginDragDropTarget() { return ImGui::BeginDragDropTarget(); }
...
ZGUI_API void zguiEndDragDropTarget() { return ImGui::EndDragDropTarget(); }
...
ZGUI_API void zguiImGuiPayload_Clear(ImGuiPayload *payload)
{
    payload->Clear();
}

ZGUI_API bool zguiImGuiPayload_IsDataType(
    const ImGuiPayload *payload, const char *type
)
{
...
ZGUI_API void zguiEndCombo(void) { ImGui::EndCombo(); }
...
ZGUI_API void zguiEndListBox(void) { ImGui::EndListBox(); }

ZGUI_API bool zguiSelectable(
    const char *label,
    bool selected,
...
)
{
    return ImGui::VSliderScalar(
        label, {w, h}, data_type, p_data, p_min, p_max, format, flags
    );
}
...
ZGUI_API void zguiInputTextCallbackData_DeleteChars(
    ImGuiInputTextCallbackData *data, int pos, int bytes_count
)
{
...
)
{
    return ImGui::InputTextMultiline(
        label, buf, buf_size, {w, h}, flags, callback, user_data
    );
}
...
)
{
    return ImGui::InputScalarN(
        label, data_type, p_data, components, p_step, p_step_fast, format, flags
    );
}

ZGUI_API bool zguiColorEdit3(
...
ZGUI_API bool zguiColorPicker3(
    const char *label, float col[3], ImGuiColorEditFlags flags
)
{
...
ZGUI_API bool zguiColorPicker4(
    const char *label,
    float col[4],
...
)
{
    return ImGui::ColorButton(
        desc_id, {col[0], col[1], col[2], col[3]}, flags, {w, h}
    );
}
...
{
    assert(out_w && out_h);
    const ImVec2 s = ImGui::CalcTextSize(
        txt, txt_end, hide_text_after_double_hash, wrap_width
    );
    *out_w = s.x;
    *out_h = s.y;
}
...
ZGUI_API bool zguiInvisibleButton(
    const char *str_id, float w, float h, ImGuiButtonFlags flags
)
{
...
ZGUI_API void zguiBullet(void) { ImGui::Bullet(); }
...
ZGUI_API bool zguiCheckboxBits(
    const char *label, unsigned int *bits, unsigned int bits_value
)
{
    return ImGui::CheckboxFlags(label, bits, bits_value);
}

ZGUI_API void zguiProgressBar(
    float fraction, float w, float h, const char *overlay
)
{
...
ZGUI_API ImGuiListClipper zguiListClipper_Init() { return ImGuiListClipper(); }

ZGUI_API void zguiListClipper_Begin(
    ImGuiListClipper *clipper, int items_count, float items_height
)
{
    clipper->Begin(items_count, items_height);
}

ZGUI_API void zguiListClipper_End(ImGuiListClipper *clipper) { clipper->End(); }

ZGUI_API void zguiListClipper_IncludeItemsByIndex(
    ImGuiListClipper *clipper, int item_begin, int item_end
)
{
...
ZGUI_API ImGuiStyle *zguiGetStyle(void) { return &ImGui::GetStyle(); }

ZGUI_API ImGuiStyle zguiStyle_Init(void) { return ImGuiStyle(); }
...
ZGUI_API void zguiPopStyleColor(int count) { ImGui::PopStyleColor(count); }
...
ZGUI_API void zguiPopStyleVar(int count) { ImGui::PopStyleVar(count); }
...
ZGUI_API void zguiPopItemWidth(void) { ImGui::PopItemWidth(); }
...
ZGUI_API void zguiSetItemDefaultFocus(void) { ImGui::SetItemDefaultFocus(); }

ZGUI_API ImFont *zguiGetFont(void) { return ImGui::GetFont(); }

ZGUI_API float zguiGetFontSize(void) { return ImGui::GetFontSize(); }
...
ZGUI_API void zguiPushFont(ImFont *font) { ImGui::PushFont(font); }

ZGUI_API void zguiPopFont(void) { ImGui::PopFont(); }

ZGUI_API bool zguiTreeNode(const char *label) { return ImGui::TreeNode(label); }
...
ZGUI_API bool zguiTreeNodeStrIdFlags(
...
ZGUI_API bool zguiTreeNodePtrIdFlags(
...
ZGUI_API bool zguiCollapsingHeaderStatePtr(
...
ZGUI_API void zguiTreePushStrId(const char *str_id) { ImGui::TreePush(str_id); }

ZGUI_API void zguiTreePushPtrId(const void *ptr_id) { ImGui::TreePush(ptr_id); }

ZGUI_API void zguiTreePop(void) { ImGui::TreePop(); }
...
ZGUI_API void zguiPushStrIdZ(const char *str_id) { ImGui::PushID(str_id); }

ZGUI_API void zguiPushPtrId(const void *ptr_id) { ImGui::PushID(ptr_id); }

ZGUI_API void zguiPushIntId(int int_id) { ImGui::PushID(int_id); }

ZGUI_API void zguiPopId(void) { ImGui::PopID(); }
...
{
    return ImGui::GetIO().Fonts->AddFontFromFileTTF(
        filename, size_pixels, nullptr, nullptr
    );
}
...
)
{
    return ImGui::GetIO().Fonts->AddFontFromMemoryTTF(
        font_data, font_size, size_pixels, config, ranges
    );
}

ZGUI_API ImFont *zguiIoAddFontFromMemory(
...
)
{
    ...
    return ImGui::GetIO().Fonts->AddFontFromMemoryTTF(
        font_data, font_size, size_pixels, &config, nullptr
    );
}

ZGUI_API ImFontConfig zguiFontConfig_Init(void) { return ImFontConfig(); }
...
ZGUI_API float zguiIoFramerate() { return ImGui::GetIO().Framerate; }
...
ZGUI_API void zguiIoSetKeyEventNativeData(
    ImGuiKey key, int keycode, int scancode
)
{
...
ZGUI_API bool zguiIsItemActive(void) { return ImGui::IsItemActive(); }

ZGUI_API bool zguiIsItemFocused(void) { return ImGui::IsItemFocused(); }
...
ZGUI_API bool zguiIsItemVisible(void) { return ImGui::IsItemVisible(); }
...
ZGUI_API bool zguiIsItemEdited(void) { return ImGui::IsItemEdited(); }

ZGUI_API bool zguiIsItemActivated(void) { return ImGui::IsItemActivated(); }

ZGUI_API bool zguiIsItemDeactivated(void) { return ImGui::IsItemDeactivated(); }
...
ZGUI_API bool zguiIsItemToggledOpen(void) { return ImGui::IsItemToggledOpen(); }

ZGUI_API bool zguiIsAnyItemHovered(void) { return ImGui::IsAnyItemHovered(); }

ZGUI_API bool zguiIsAnyItemActive(void) { return ImGui::IsAnyItemActive(); }

ZGUI_API bool zguiIsAnyItemFocused(void) { return ImGui::IsAnyItemFocused(); }
...
ZGUI_API void zguiPopTextWrapPos(void) { ImGui::PopTextWrapPos(); }
...
ZGUI_API bool zguiBeginTabItem(
    const char *string, bool *p_open, ImGuiTabItemFlags flags
)
{
    return ImGui::BeginTabItem(string, p_open, flags);
}

ZGUI_API void zguiEndTabItem(void) { ImGui::EndTabItem(); }

ZGUI_API void zguiEndTabBar(void) { ImGui::EndTabBar(); }
...
ZGUI_API bool zguiBeginMenuBar(void) { return ImGui::BeginMenuBar(); }

ZGUI_API void zguiEndMenuBar(void) { ImGui::EndMenuBar(); }

ZGUI_API bool zguiBeginMainMenuBar(void) { return ImGui::BeginMainMenuBar(); }

ZGUI_API void zguiEndMainMenuBar(void) { ImGui::EndMainMenuBar(); }
...
ZGUI_API void zguiEndMenu(void) { ImGui::EndMenu(); }

ZGUI_API bool zguiMenuItem(
...
ZGUI_API bool zguiBeginTooltip(void) { return ImGui::BeginTooltip(); }
...
ZGUI_API bool zguiBeginPopupModal(
...
ZGUI_API void zguiEndPopup(void) { ImGui::EndPopup(); }
...
ZGUI_API void zguiCloseCurrentPopup(void) { ImGui::CloseCurrentPopup(); }
...
)
{
    return ImGui::BeginTable(
        str_id, column, flags, {outer_size[0], outer_size[1]}, inner_width
    );
}

ZGUI_API void zguiEndTable(void) { ImGui::EndTable(); }
...
ZGUI_API bool zguiTableNextColumn(void) { return ImGui::TableNextColumn(); }
...
ZGUI_API void zguiTableHeadersRow(void) { ImGui::TableHeadersRow(); }

ZGUI_API void zguiTableHeader(const char *label) { ImGui::TableHeader(label); }
...
ZGUI_API int zguiTableGetRowIndex(void) { return ImGui::TableGetRowIndex(); }
...
ZGUI_API void zguiTableSetBgColor(
...
ZGUI_API void zguiColorConvertRGBtoHSV(
...
ZGUI_API void zguiColorConvertHSVtoRGB(
...
//
//--------------------------------------------------------------------------------------------------
ZGUI_API bool zguiIsKeyDown(ImGuiKey key) { return ImGui::IsKeyDown(key); }
...
ZGUI_API void zguiDrawList_SetFlags(
    ImDrawList *draw_list, ImDrawListFlags flags
)
{
...
ZGUI_API void zguiDrawList_PushTextureId(
    ImDrawList *draw_list, ImTextureID texture_id
)
{
...
ZGUI_API void zguiDrawList_GetClipRectMin(
    ImDrawList *draw_list, float clip_min[2]
)
{
...
ZGUI_API void zguiDrawList_GetClipRectMax(
    ImDrawList *draw_list, float clip_max[2]
)
{
...
{
    draw_list->AddRect(
        {pmin[0], pmin[1]}, {pmax[0], pmax[1]}, col, rounding, flags, thickness
    );
}
...
)
{
    draw_list->AddRectFilled(
        {pmin[0], pmin[1]}, {pmax[0], pmax[1]}, col, rounding, flags
    );
}
...
)
{
    draw_list->AddQuadFilled(
        {p1[0], p1[1]}, {p2[0], p2[1]}, {p3[0], p3[1]}, {p4[0], p4[1]}, col
    );
}
...
)
{
    draw_list->AddTriangle(
        {p1[0], p1[1]}, {p2[0], p2[1]}, {p3[0], p3[1]}, col, thickness
    );
}
...
)
{
    draw_list->AddTriangleFilled(
        {p1[0], p1[1]}, {p2[0], p2[1]}, {p3[0], p3[1]}, col
    );
}
...
{
    draw_list->AddCircle(
        {center[0], center[1]}, radius, col, num_segments, thickness
    );
}
...
)
{
    draw_list->AddCircleFilled(
        {center[0], center[1]}, radius, col, num_segments
    );
}
...
)
{
    draw_list->AddPolyline(
        (const ImVec2 *)&points[0][0], num_points, col, flags, thickness
    );
}

ZGUI_API void zguiDrawList_AddConvexPolyFilled(
    ImDrawList *draw_list, const float points[][2], int num_points, ImU32 col
)
{
    draw_list->AddConvexPolyFilled(
        (const ImVec2 *)&points[0][0], num_points, col
    );
}
...
ZGUI_API void zguiDrawList_PathLineToMergeDuplicate(
    ImDrawList *draw_list, const float pos[2]
)
{
...
ZGUI_API void zguiDrawList_PathStroke(
    ImDrawList *draw_list, ImU32 col, ImDrawFlags flags, float thickness
)
{
...
{
    draw_list->PathArcTo(
        {center[0], center[1]}, radius, a_min, a_max, num_segments
    );
}
...
)
{
    draw_list->PathArcToFast(
        {center[0], center[1]}, radius, a_min_of_12, a_max_of_12
    );
}
...
)
{
    draw_list->PathBezierCubicCurveTo(
        {p2[0], p2[1]}, {p3[0], p3[1]}, {p4[0], p4[1]}, num_segments
    );
}
...
)
{
    draw_list->PathBezierQuadraticCurveTo(
        {p2[0], p2[1]}, {p3[0], p3[1]}, num_segments
    );
}
...
{
    draw_list->PathRect(
        {rect_min[0], rect_min[1]}, {rect_max[0], rect_max[1]}, rounding, flags
    );
}

ZGUI_API void zguiDrawList_PrimReserve(
    ImDrawList *draw_list, int idx_count, int vtx_count
)
{
...
ZGUI_API void zguiDrawList_PrimRect(
    ImDrawList *draw_list, const float a[2], const float b[2], ImU32 col
)
{
...
)
{
    draw_list->PrimRectUV(
        {a[0], a[1]}, {b[0], b[1]}, {uv_a[0], uv_a[1]}, {uv_b[0], uv_b[1]}, col
    );
}
...
ZGUI_API void zguiDrawList_PrimWriteVtx(
    ImDrawList *draw_list, const float pos[2], const float uv[2], ImU32 col
)
{
...
ZGUI_API void zguiDrawList_AddCallback(
    ImDrawList *draw_list, ImDrawCallback callback, void *callback_data
)
{
...
//--------------------------------------------------------------------------------------------------
ZGUI_API ImGuiID
zguiDockSpace(const char *str_id, float size[2], ImGuiDockNodeFlags flags)
{
    return ImGui::DockSpace(ImGui::GetID(str_id), {size[0], size[1]}, flags);
}

ZGUI_API ImGuiID zguiDockSpaceOverViewport(
...
)
{
    return ImGui::DockSpaceOverViewport(
        dockspace_id, viewport, dockspace_flags
    );
}
...
//
//--------------------------------------------------------------------------------------------------
ZGUI_API void zguiDockBuilderDockWindow(
...
ZGUI_API ImGuiID
zguiDockBuilderAddNode(ImGuiID node_id, ImGuiDockNodeFlags flags)
{
